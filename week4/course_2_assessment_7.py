...
print (test(4))
print (test(2,False))
print (test(4,True,{1:7, 4:8, 9:0}))
print (test(4,False,{1:7, 4:8, 9:0}))
...
print (checkingIfIn("any"))
print (checkingIfIn("apple"))
print (checkingIfIn("apple",False))
print (checkingIfIn("any",False))
print (checkingIfIn("pear",True))
print (checkingIfIn("pear",True,{'a':4,'pear':6}))
...
c_true = checkingIfIn('pussy',False)
print (c_true)
# Call the function so that the value of fruit is assigned to the variable fruit_ans
fruit_ans = checkingIfIn('fruit')
print (fruit_ans)
# Call the function using the first and third parameter so that the value 8 is assigned to the variable param_check
param_check = checkingIfIn('boy',d={'boy':8,'girl':2})
print (param_check)
